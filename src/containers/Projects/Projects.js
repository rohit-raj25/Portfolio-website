...
const projects =()=>{
  ...
  const projectSection = {
    ...
    projectsCards: [
      ...
      {
        title: "Tagonizer",
        subtitle: "AI-powered Chrome Extension for E-commerce websites to show tags autogenerated from reviews and the attached sentiments (Positive/Negative/Moderate).",
